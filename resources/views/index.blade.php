        ...
        <div class="container clearfix">
            <div class="row">
                <div class="col-xs-10 col-xs-offset-1 text-center">
                    <h1 class="title-text">サービスお申込み</h1>
                </div>
                    ...
                    <div class="panel panel-design">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="pull-left">
                                ...
                                <p class="accent-text">※初月無料</p>
                            </div>
                            <div class="pull-right col-xs-8 col-sm-3">
                                <button class="btn btn-lg btn-design" data-featherlight="#applicationBox" type="submit">お申込み</button>
                            </div>
                        </div>
